...
public class ViewBeans {
    ...
    static BiMap<Integer, String> views = new ImmutableBiMap.Builder<Integer, String>()
            ...
            .build();
            //LoadingIndicator, MaterialDivider and BottomSheetDragHandleView are not added so as not to add onClick event.
    ...
    public static int getViewTypeResId(int id) {
        return switch (id) {
            ...
            default -> DayDreamViewBeans.getViewTypeResId(id);
        };
    }
}
