...
/**
 * This is a command line tools used by mainDexClasses script to build a main dex classes list. First
 ...
 * are not opened by this tools only their names matter. Other arguments must be zip files or
 ...
 * their dependencies to other classes. The tools also browses for classes annotated by runtime
...
public class MainDexListBuilder {
    ...
    private static final String USAGE_MESSAGE =
            ...
            "Slightly longer version: This tools is used by mainDexClasses script to build" + EOL +
