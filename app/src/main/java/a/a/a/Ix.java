...
public class Ix {
    ...
    public String a() {
        ...
        if (DRFeatureManager.isOneSignalEnabled(c.sc_id, null)) {
            ...
            writePermission(a, Manifest.permission.POST_NOTIFICATIONS);
        ...
        if (DRFeatureManager.isOnBackInvokedCallbackEnabled(c.sc_id, null))
        ...
        for (ProjectFileBean projectFileBean : b) {
            if (!(projectFileBean.fileName.contains("_fragment")
                    || DayDreamProjectSettings.getActivityType(c.sc_id, projectFileBean.getActivityName()).contains("_fragment"))) {
