    ...
    private void initializeClassPath() {
        ...
        switch (className) {
            ...
            case "LoadingIndicator":
                classInfos = "View.Clickable.LoadingIndicator";
                break;
            ...
            case "MaterialDivider":
                classInfos = "View.Clickable.MaterialDivider";
                break;

            case "BottomSheetDragHandleView":
                classInfos = "View.Clickable.BottomSheetDragHandleView";
                break;
