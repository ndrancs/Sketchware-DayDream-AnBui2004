...
import extensions.anbui.daydream.viewbeans.view.item.DRItemBottomSheetDragHandleView;
import extensions.anbui.daydream.viewbeans.view.item.DRItemLoadingIndicator;
import extensions.anbui.daydream.viewbeans.view.item.DRItemMaterialDivider;
...
//    private final FirebaseCrashlytics crashlytics = FirebaseCrashlytics.getInstance();
    ...
    public View createItemView(ViewBean viewBean) {
        View item = switch (viewBean.type) {
            ...
            case DayDreamViewBeans.VIEW_TYPE_WIDGET_LOADINGINDICATOR -> new DRItemLoadingIndicator(context);
            case DayDreamViewBeans.VIEW_TYPE_WIDGET_MATERIALDIVIDER -> new DRItemMaterialDivider(context);
            case DayDreamViewBeans.VIEW_TYPE_WIDGET_BOTTOMSHEETDRAGHANDLEVIEW -> new DRItemBottomSheetDragHandleView(context);
