...
import extensions.anbui.daydream.viewbeans.view.palette.DRIconBottomSheetDragHandleView;
import extensions.anbui.daydream.viewbeans.view.palette.DRIconLoadingIndicator;
import extensions.anbui.daydream.viewbeans.view.palette.DRIconMaterialDivider;
...
public class PaletteWidget extends LinearLayout {
    ...
    public View extraWidget(String tag, String title, String name) {
        ...
        iconBase = switch (title) {
            ...
            case "LoadingIndicator" -> new DRIconLoadingIndicator(context);
            case "MaterialDivider" -> new DRIconMaterialDivider(context);
            case "BottomSheetDragHandleView" -> new DRIconBottomSheetDragHandleView(context);
