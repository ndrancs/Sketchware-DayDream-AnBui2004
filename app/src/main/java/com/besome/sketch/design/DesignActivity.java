...
import extensions.anbui.daydream.activity.project.settings.DayDreamGeneralSettings;
...
//    private final FirebaseCrashlytics crashlytics = FirebaseCrashlytics.getInstance();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRun.setOnClickListener(v -> {
            if (currentBuildTask != null && !currentBuildTask.isCanceling && currentBuildTask.isBuilding) {
                currentBuildTask.cancelBuild();
                return;
            }
        ...
        GitQuickLook.isQuickLook(this, sc_id, true);
    }
    ...
    public void onResume() {
        ...
        if (needReloadProjectData) {
            ...
            if (mSavedInstanceState == null) {
                loader = new ProjectLoader(this, null);
            } else {
                loader = new ProjectLoader(this, mSavedInstanceState);
            }
            loader.execute();
        }
    }
...
//                  crashlytics.recordException(e);
    ...
    private void showAvailableViews(boolean isOnlyJava) {
        ...
        intent.putExtra("isOnlyJava", isOnlyJava);
    ...
    private static class BuildTask extends BaseTask implements BuildProgressReceiver {
        ...
        private volatile boolean isBuilding;
